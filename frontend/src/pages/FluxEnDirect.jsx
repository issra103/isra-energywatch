        ...
        <div className="glass-panel" style={{ padding: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: '0.5rem' }}>
            {Object.entries(stats.byType).map(([type, count]) => {
              ...
              return (
                <span key={type} className="badge" style={{ fontSize: '0.7rem', display: 'flex', alignItems: 'center', gap: 4 }}>
                  {IconComponent && <IconComponent size={12} />} {type}: {count}
                </span>
              );
            })}
          </div>
                ...
                <div key={log._id || i} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{
                      ...
                      display: 'flex', alignItems: 'center', justifyContent: 'center', color: isAnomaly ? '#ef4444' : '#6366f1',
                    }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    {isAnomaly && (
                      <div style={{ fontSize: '0.65rem', fontWeight: 800, color: '#ef4444', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 4, justifyContent: 'flex-end' }}>
